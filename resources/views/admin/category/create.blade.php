                ...
                <div class="col-lg-9 col-md-9 col-12">
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            ...
                            <div class="row form-group">
                                ...
                                <label class="col-lg-8">
                                    <span class="alert-warning">
                                        *Remembar: This will allow to display in 'Best Our Collections Section in homepage.'
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="row form-group">
                                <label for="" class="col-sm-3">Show In Home Page:</label>
                                <div class="col-sm-1">
                                    <label class="ui-checkbox ui-checkbox-warning">
                                        <input type="checkbox" name="show_in_home_page"  value="1" id="show_in_home_page" {{@($category_info->show_in_home_page == 0) ? "unchecked": "checked"}} >  
                                        <span class="input-span"></span>Yes 
                                    </label>
                                </div>
                                <label class="col-lg-8"><span class="alert-warning">*Remembar:Don't tick on this menu if  this is not a home page category.</span></label>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <label class="ui-checkbox ui-checkbox-warning">
                                        <input type="checkbox" name="is_parent"  value="1" id="is_parent" {{@($category_info->is_parent == 0) ? "unchecked": "checked"}} >      
                                        <span class="input-span"></span>Yes 
                                    </label>
                            ...
                            <div class="row form-group hidden" id="sub_parent">
                                <label class="col-sm-3">Sub Parent Categories:</label>
                                <div class="col-sm-9">
                                    <select name="parent_id" id="child_parent_id" class="form-control">
                                    </select>
                                </div>
                            </div>
                ...
                <div class="col-lg-3">
                    <div class="ibox">
                        <div class="ibox-body">
                            ...
                            @endphp
                            @if(isset($category_info->image) && !empty($category_info->image) && file_exists(public_path().'/uploads/category/main/'.$category_info->image))
                                @php
                                $thumbnail = asset('/uploads/category/main/'.$category_info->image);
                                @endphp
                            @endif 
                            <div class="form-group">
                                <div class="m-r-10">
...
<script>
    ...
    $(document).ready(function(){
        $('#parent_id').change( function(){
            var cat_id = $(this).val();
            if (cat_id) {
                var url = '{{ route("getSubCatByCatId", ":id") }}';
                url = url.replace(':id', cat_id);
                $.ajax({
                    url : url,
                    method:"get",
                    success : function(response){
                        $('#child_parent_id').html(response.html);
                        if (response.status == true) {
                            $('#sub_parent').removeClass('hidden');
                        }
                        if (response.status == false) {
                            $('#sub_parent').addClass('hidden');
                            $('#child_parent_id').html('');
