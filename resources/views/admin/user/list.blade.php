...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Customer</div>
        </div>
            ...
            <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr class="category_row{{$user_data->id}}">
                        ...
                        <td class="changeStatus{{$user_data->id}}">

                            <span class="btn btn-rounded btn-sm {{($user_data->publish == 'Active') ? 'btn-success':   'btn-warning'  }} changeStatus" data-status="{{$user_data->status}}" data-id = "{{$user_data->id}}" style="cursor: pointer;">{{($user_data->publish == 1) ? 'Active':   'Inactive'  }}</span>
                        ...
                        <td>
                            <ul class="action_list">
                            	{{--
                                <li>
                                    <a href="{{route('advertise.edit', $user_data->id)}}" data- class="btn btn-info btn-md"><i class="fa fa-edit"></i></a>
                                </li>
                                --}}
