                        ...
                        <div class="ibox-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 form-group">
                                    ...
                                    <option value="{{$product['id']}}" {{($user_info->products->where('id',$product['id'])->count()==0)?'':'selected'}}>{{$product['name']}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="ibox-body">
                            ...
                            <div class="form-group">
                                        <label class="ui-checkbox ui-checkbox-primary" style="margin-top: 35px;">
                                            <input type="checkbox" name="status" {{((@$user_info->status == 1) ? 'checked' : '')}}>
