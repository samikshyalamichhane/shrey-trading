                                    ...
                                    <form class="form form-responsive form-horizontal" enctype= "multipart/form-data" method="post" action="{{route('address-update')}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 form-group">
                                                ...
                                                <input class="form-control" type="text" placeholder="Ex: New Baneshwor-25 Shankhamul" name="location" value="{{@$web_info->location}}">
                                    ...
                                    {{csrf_field()}}
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 form-group">
                                                ...
                                                <input class="form-control" type="text" placeholder="pInterest ID" name="pinterest_id" value="{{@$web_info->pinterest_id}}">
                                            ...
                                            <div class="col-sm-12 form-group">
                                                <label>RSS ID</label>
                                                <input class="form-control" type="text" placeholder="RSS ID" name="rss_id" value="{{@$web_info->rss_id}}">
                                                @if($errors->has('rss_id'))
                                                <span class=" alert-danger">{{$errors->first('rss_id')}}</span>
                                                @endif
                                            </div>
