            ...
            <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr class="category_row{{$slider_data->id}}">
                        <td> {{$key +1}}</td>
                        <td>
                            @if(isset($slider_data->image) && !empty($slider_data->image) && file_exists(public_path().'/uploads/slider/'.$slider_data->image))
                            <img src="{{asset('/uploads/slider/'.$slider_data->image)}}" alt="No Image" class=" img img-thumbnail  img-sm rounded" style="max-width: 150px;">
                            @endif
                        </td>
                        
                        <td class="text-capitalize"> {{$slider_data->title}}</td>
                        <td>{{$slider_data->sub_title}}</td>
                        ...
                        <td>
                            ...
                            <span class="btn btn-rounded btn-sm {{($slider_data->status == 'Publish') ? 'btn-success':   'btn-warning'  }} category_status" data-status="{{$slider_data->status}}" data-slider_id = "{{$slider_data->id}}" style="cursor: pointer;">{{$slider_data->status}}ed</span>
